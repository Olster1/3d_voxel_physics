...
int main(int argc, char **argv) {
  ...
  SDL_Window *window = SDL_CreateWindow("Voxel Craft Game",  SDL_WINDOWPOS_CENTERED,  SDL_WINDOWPOS_CENTERED, gameState->screenWidth, gameState->screenWidth*gameState->aspectRatio_y_over_x, flags);
  ...
  while (!quit) {
    ...
    updateKeyState(gameState, KEY_R, currentKeyStates[SDL_SCANCODE_R] == 1);
